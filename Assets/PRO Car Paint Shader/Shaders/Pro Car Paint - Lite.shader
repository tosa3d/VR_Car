Shader "Hidden / Pro Car Paint - Lite"
{
	Properties
	{
		...
		_ReflectionBlur("Reflection Blur", Range( 0 , 8)) = 8
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float3 temp_cast_61 = _Metallic;
			float3 temp_cast_83 = _Glossiness;
			...
			#else
			float3 BD = lerp( Reflection1828 + BaseLayer54 , Reflection1828 , ReflectionMask2215);
			#endif
			#else
			float3 BD = BaseLayer54;
			#endif
			...
			#ifdef CLEARCOAT
			#ifdef CLEARCOAT_UNDER
			float3 BD = lerp( lerp( Reflection1828 + BaseLayer54 , Reflection1828 , ReflectionMask2215) , FlakesColor1840 , FlanksMask1368);
			#else
			#ifdef CLEARCOAT_FIRST
			float3 BD = lerp( Reflection1828 + lerp( BaseLayer54 , FlakesColor1840 , FlanksMask1368) ,  Reflection1828 , ReflectionMask2215);
			#else
			...
			float3 AD = lerp( lerp( lerp( BD , _1DecalColor * tex2D47_g553 , tex2D47_g553.a ) , _2DecalColor * tex2D52_g553 , tex2D52_g553.a ) , _3DecalColor * tex2D49_g553 , tex2D49_g553.a );
			float DecalsMask1627 = saturate( tex2D47_g553.a + tex2D52_g553.a + tex2D49_g553.a );
			#else
			float3 AD = BD;
			#endif
			#ifdef FLAKE
			...
			#ifdef CLEARCOAT_FIRST
			float3 Final_Albedo = lerp( lerp( Reflection1828 + AD , Reflection1828 , ReflectionMask2215) , FlakesColor1840 , FlanksMask1368);
			#else
			float3 Final_Albedo = lerp( AD , FlakesColor1840 , FlanksMask1368);
			#endif
			#else
			float3 Final_Albedo = lerp( Reflection1828 + lerp( AD , FlakesColor1840 , FlanksMask1368) , Reflection1828 , ReflectionMask2215);
			...
			float3 Final_Albedo = AD;
			#else
			float3 Final_Albedo = lerp( Reflection1828 + AD , Reflection1828 , ReflectionMask2215);
			#endif
			#endif
			#else
			float3 Final_Albedo = AD;
			...
			s14_g611.Specular = 1;
			s14_g611.Smoothness = _ClearCoatSmoothness;
