Shader "Hidden / Pro Car Paint Transparent - Lite"
{
	Properties
	{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float3 BD = lerp( Reflection1350 + BaseLayer1354 , Reflection1350 , ReflectionMask1351);
			#else
			...
			float3 AD = lerp( lerp( lerp( BD , _1DecalColor * tex2D47_g39 ,  tex2D47_g39.a ) , _2DecalColor * tex2D52_g39 ,  tex2D52_g39.a ) , _3DecalColor * tex2D49_g39 ,  tex2D49_g39.a );
			#else
			float3 AD = BD;
			#endif
			#ifdef DECAL
			...
			#else
			float3 Final_Albedo = lerp( ( ( Reflection1350 ) + AD ) , Reflection1350 , (ReflectionMask1351).xxxx);
			#endif
			#else
			float3 Final_Albedo = AD;
			#endif
			...
			s1265.Emission = _EmissionColor ;
			s1265.Metallic = _Metallic;
			s1265.Smoothness = _Glossiness;
			s1265.Occlusion = 1.0;
			data.light = gi.light;
			UnityGI gi1265 = gi;
